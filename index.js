...
app.get('/',(req,res) => {
  res.sendFile('D:/Node/payment/index.html');
})

app.get('/api/qrcode',(req,res) =>{
    var amt = req.query.amt;
    QRcode.toDataURL(`upi://pay?pa=9265202360@paytm&am=${amt}`,(err,url) => {
        if (err) throw err;
...
<!-- Logo -->
<div class="logo">
  <h3>Lannister<span>Pays</span></h3>
</div>
<!-- Nav Menu -->
<ul class="menu">
  <li><a class="get-btn" href="/">Home</a></li>
...
<p>Deisgned & Developed by Hydrazine</p>
</footer> 
          <br>
          ...
          <br>
            ...
            justify-content: center;
            align-items: center;
        "><img class="qrcode" src="${url}" alt="" /></div>
        <br>
            <div>
              <h3>
                <h1>Amount:₹${amt}
